...
from wtforms import StringField, PasswordField, SubmitField, BooleanField # Tipos de dados
...
class FormLogin(FlaskForm):
    ...
    botao_submit_login = SubmitField('Fazer Login') # Botão não preeche, não precisa de validators
